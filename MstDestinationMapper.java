...
public interface MstDestinationMapper {
	 ...
	 * @return 登録件数
	 */
	@Insert (value = "INSERT INTO mst_destination (user_id, family_name, first_name, tel_number, address) VALUES (#{userId}, #{familyName}, #{firstName}, #{telNumber}, #{address})")
	 ...
	 * @return 削除件数
	 */
	@Update(value = "UPDATE mst_destination SET status = 0, updated_at = NOW() WHERE id = #{id}")
